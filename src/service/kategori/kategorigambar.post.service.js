...
export const postKategoriImage = async (id, imageFile) => {
  ...
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_APP_API}superadmin/product/category/update-image/${id}`,
    ...
    console.error(
      "Error uploading kategori image:",
