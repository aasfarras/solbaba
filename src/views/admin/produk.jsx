...
import { getProduct } from "../../service/admin/product/product.get.service";
...
import { deleteProduct } from "../../service/admin/product/product.delete.service";
...
const Product = () => {
  ...
  const handleUpdate = (rowIndex) => {
    ...
    window.location.href = `/admin/manajemen/produk/editproduk/${productId}`;
  ...
  const handleDetail = (rowIndex) => {
    ...
    window.location.href = `/admin/manajemen/produk/detailproduk/${productId}`; // Adjust the path based on your routing setup
  };
