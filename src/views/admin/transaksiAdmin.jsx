...
import { getTransaksiAdmin } from "../../service/admin/transaksi.get.service"; // Ganti dengan path yang sesuai
import { useNavigate } from "react-router-dom";
import { updateTransaksiAdmin } from "../../service/admin/transaksi.update.service"; // Ganti dengan path yang sesuai
import { getTransaksiAdminById } from "../../service/admin/transaksi.detail.service";
...
const Transaksi = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const result = await getTransaksiAdmin();
  ...
  const handleDetail = async (rowIndex) => {
    ...
    try {
      ...
      await getTransaksiAdminById(PesananId); // Ganti dengan fungsi yang sesuai untuk mendapatkan detail
      navigate(`/admin/manajemen/transaksi/detailTransaksi/${PesananId}`);
    } catch (error) {
  ...
  const handleSubmitStatus = async () => {
    try {
      await updateTransaksiAdmin(currentPesananId, { status: selectedStatus });
