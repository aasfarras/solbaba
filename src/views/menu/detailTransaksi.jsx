...
import { getTransaksiSalesmanById } from "../../service/sales-route/transaksi.detail.service"; // Import the new service
...
const DetailTransaksi = () => {
  ...
  const fetchTransactionDetails = async () => {
    setLoading(true);
    try {
      const data = await getTransaksiSalesmanById(id); // Use the service to fetch transaction details
      setTransaction(data);
    } catch (error) {
              ...
              <TableContainer>
                <Table>
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell>Produk Sub kategori</TableCell>
                      <TableCell>
